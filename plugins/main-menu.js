...
let time = moment.tz('Asia/Jakarta').format('HH:mm:ss') 
    ...
    let qt = pickRandom(global.quotes)
...
function ucapan() {
  ...
  let res = "Masbro ngapain jam segini masih blom tidur? 😱"
  if (time >= 4) {
    res = "Selamat Pagi"
  }
  if (time >= 10) {
